...
if(isset($argv[1]) && $argv[1] !== ''){
	...
	$data = array('wallet' => $argv[1],'refby' => 'LTC1682','botprotection' => 'im not','submit' => 'Login','submit_address' => 1);
}else{
	die("wallet address not found\n");
}
$url['login'] = 'http://freebitcoincash.cryptoplanets.org/DJSNChdiej73dosN8S7KcyJltcfaucet/index.php';
$url['post'] = 'http://freebitcoincash.cryptoplanets.org/DJSNChdiej73dosN8S7KcyJltcfaucet/ajax.php';
...
function getwebPage($url, $post=null){
      ...
      curl_setopt($ch, CURLOPT_REFERER, "http://freebitcoincash.cryptoplanets.org/DJSNChdiej73dosN8S7KcyJltcfaucet/index.php");
      ...
      if(isset($post) && $post !==""){
         ...
         curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/x-www-form-urlencoded; charset=UTF-8", "X-Requested-With: XMLHttpRequest"));
      	...
      	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: text/html; charset=UTF-8", "X-Requested-With: com.org.ltcfaucet"));
      }
